      ...
      render={(data) => {
        return (
          <>
            <Wrapper>
              <H2>
                Hi, I'm Mae 👋. I'm a software engineer who has spent the last 4
                years working on design systems.
              </H2>
            </Wrapper>
            <Wrapper>
              <Text>
                I've been writing code professionally for 6 years. In the last 4
                years, I've worked on design systems and component libraries for
                companies like American Express, Harry's, and Better.com.
              </Text>
            </Wrapper>
            <Wrapper>
              <Text>
            ...
            <Wrapper>
              <Text>
                ...
                engineering managers so that they can also build lasting, robust
                design systems artifacts, like component libraries, design
                assets, processes, and automation.
              </Text>
            </Wrapper>
            <Wrapper>
            ...
            <Wrapper>
              <Text>
                ...
                sign up for my newsletter. I'll do my best to get back to you as
                soon as I can.
              </Text>
            </Wrapper>
          </>
